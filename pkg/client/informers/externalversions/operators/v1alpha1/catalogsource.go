...
import (
	...
	versioned "github.com/operator-framework/api/pkg/client/clientset/versioned"
	internalinterfaces "github.com/operator-framework/api/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/operator-framework/api/pkg/client/listers/operators/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorsV1alpha1().CatalogSources(namespace).List(context.TODO(), options)
			},
